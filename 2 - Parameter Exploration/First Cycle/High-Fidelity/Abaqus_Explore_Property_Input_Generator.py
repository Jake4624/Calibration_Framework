...
f_c = np.array([5.5,8.5])                # MPa
# Equilibrium transformation temperature
Theta_T = np.array([269.25,301.75])         # K
Theta_Ref_High = np.array([334.25,366.75])  # K
...
lambda_T = np.array([145,215])        # MJ/m^3

# Initial slip system hardness
S0 = np.array([425,675])              # MPa
# Self-hardening coefficient 
H0 = np.array([600,1200])             # MPa
