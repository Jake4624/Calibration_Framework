...
Am = np.array([0.015714,0.021429,0.027143,0.032857,0.038571,0.044286]) # -
#%% From calibration, properties will be set
...
# its reverse.
#%% Multi-cycle parameters to vary
# Material parameter
# First cycle is constatn, multi-cycle needs to be changed

d_ir = np.array([0.014371,0.028643,0.042914,0.057186,0.071457,0.085729])        # -
# First cycle is constat, multi-cycle needs to be changed
mu = np.array([0.142857,0.285714,0.428571,0.571429,0.714286,0.857143])              # -

#%% Generating output file
fileOutput = open('Properties_Abaqus_Neper.txt','w')
#
