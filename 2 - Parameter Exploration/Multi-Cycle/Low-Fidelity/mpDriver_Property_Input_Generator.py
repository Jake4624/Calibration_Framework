...
Am = np.array([0.01,0.0125,0.015,0.0175,0.02,0.0225,0.025,0.0275,0.03,0.0325,0.035,0.0375,0.04,0.0425,0.045,0.0475,0.05]) # -
...
f_c = np.array([5.7142859])               # MPa
# Equilibrium transformation temperature
Theta_T = np.array([308.71429])           # K
Theta_Ref_High = np.array([336.57144])    # K
...
lambda_T = np.array([147.14285])          # MJ/m^3

# Initial slip system hardness
S0 = np.array([657.14288])                # MPa
# Self-hardening coefficient 
H0 = np.array([1157.1428])                # MPa
...
# applied stress.
N_GEN_F = np.array([4.2857141])            # -
# Material parameter
# First cycle is constatn, multi-cycle needs to be changed
d_ir = np.array([0.0001,0.006344,0.012588,0.018831,0.025075,0.031319,0.037563,0.043806,0.05005,0.056294,0.062538,0.068781,0.075025,0.081269,0.087513,0.093756,0.1])                   # -
#d_ir = np.array([0.0001,0.00505,0.01])     # -
# Reference resistance
D_ir = np.array([0.057185717])             # -
...
# its reverse.
# First cycle is constatn, multi-cycle needs to be changed
mu = np.array([0,0.0625,0.125,0.1875,0.25,0.3125,0.375,0.4375,0.5,0.5625,0.625,0.6875,0.75,0.8125,0.875,0.9375,1])              # -
