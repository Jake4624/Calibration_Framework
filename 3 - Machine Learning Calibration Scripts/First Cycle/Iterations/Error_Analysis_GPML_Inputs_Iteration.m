...
experimental_time = table2array(experimental_data([1:161],1));
experimental_strain = table2array(experimental_data([1:161],2));
experimental_stress = table2array(experimental_data([1:161],3));
...
Abaqus_stress = importdata("Average_Stress_11_Iter_Abaqus_Sim.txt");
Abaqus_strain = importdata("Average_Strain_11_Iter_Abaqus_Sim.txt");
...
writematrix(out_Neper,'GPML_Iteration.txt')
...
legend('Iteration 1 Mean Func','Wang 4a Experimental Data','Location','best')
xlabel('Strain')
ylabel('Stress (MPa)')
...
plot(experimental_strain,experimental_stress,'--')
% legend('Iteration 4 Mean','Iteration 4 Lower Bound','Wang 4a Experimental Data')
legend('Iteration 1 Lower Bound','Wang 4a Experimental Data','Location','best')
xlabel('Strain')
ylabel('Stress (MPa)')
