...
for subfolder_num = 1:subfolders
    ...
    % Reoganize data into folders where each folder is an abaqus sim.
    % For this, since we only run one sim at a time, don't need to
    % reorganize the data.
...
writematrix([Avg_Stress_All],"Average_Stress_11_First_Iter_Abaqus_Sim.txt")
writematrix([Avg_Strain_All],"Average_Strain_11_First_Iter_Abaqus_Sim.txt")
